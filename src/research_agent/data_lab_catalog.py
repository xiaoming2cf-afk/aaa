...
MODEL_FAMILY_CATALOG: list[dict[str, object]] = [
    ...
    },
    {
        ...
        "category": "model",
        "category_label": "Model",
        "summary": "Forecasting and dynamic system models for ordered macro-finance data.",
        "description": "Use this family when time ordering is central to the question. These models focus on serial dependence, forecasting, and multivariate dynamic interactions across macro-finance variables.",
        "key_inputs": [
            "Time column",
            "Series variable or multivariate series selection",
            "Lag order, ARIMA order, and forecast horizon",
        ],
        "manual_checks": [
            "Confirm the time column sorts correctly before estimation.",
            "Recompute lagged design terms or forecast inputs in the downloaded sample.",
            "Verify forecast horizons and lag order against the model specification panel.",
        ],
        "methods": [
